...
|**annealing**            | the current version allows annealing simulation with a default set of temperatures (**annealing = 0**) or a user-defined temperatures (**annealing = 1**). If **annealing = 0**, no extra parameter is needed; he number of annealing cycle is *9*. If **annealing = 1**, addition parameters are required as follows:|
| ----------------------: |-------------------------------------------------------------------------------------------------------|
