...
!     more than one chain
      ...
      subroutine phipsianalysis(readchain)
...
#include "def.h"
	...
	use inputreadin
      ...
      integer readchain, readnb, readchnln
...
!      cycle through residues 2 through chnln-1 for each chain
       do i=(k-1)*readnb+2,(k-1)*readnb+readchnln-1
         pos_n=readchnln+i
         xn=sv(1,pos_n)
         yn=sv(2,pos_n)
         zn=sv(3,pos_n)
         ...
         pos_n_p1=readchnln+i+1
         xn_p1=sv(1,pos_n_p1)
         yn_p1=sv(2,pos_n_p1)
         zn_p1=sv(3,pos_n_p1)
         
         pos_c_m1=2*readchnln+i-1
         xc_m1=sv(1,pos_c_m1)
         yc_m1=sv(2,pos_c_m1)
         zc_m1=sv(3,pos_c_m1)
